...
export default function Contact() {
  ...
  const form = useForm<z.infer<typeof insertContactInquirySchema>>({
  ...
  const mutation = useMutation({
    mutationFn: async (values: z.infer<typeof insertContactInquirySchema>) => {
  ...
  function onSubmit(values: z.infer<typeof insertContactInquirySchema>) {
